        ...
        <nav className="relative container mx-auto p-6">
            ...
            <div className="flex items-center justify-between">
                ...
                <Link href={ROUTES.contactUs}>
                    <a href="#" className="p-1 px-1 pt-2 text-veryLightGray bg-electricGreen rounded-lg baselin md:block">Contact Us</a>
                    {/* hover:bg-green-300 */}
                </Link>
...
export const HeaderContainer = ({ title, description, bgContainer, headerContainer }: HeaderType) => {
    return (
        <div className={`flex flex-1 flex-col h-full w-full bg-no-repeat bg-cover bg-[url('/img/header_background_01.svg')] object-contain ${bgContainer}`}>
            <Header />
            ...
            <section id="header-background" className={`flex w-full flex-1 flex-col items-center px-20 text-center font-Comfortaa ${headerContainer}`}>
                <div className='flex flex-col space-y-4 text-white items-center justify-center'>
                    ...
                    <div className='text-electricGreen tracking-tight items-center justify-center'>{description} </div>
                </div>
